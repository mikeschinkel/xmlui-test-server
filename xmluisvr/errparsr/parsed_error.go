...
//		err = doterr.WithErr(err,
//			"message_index", index,
//			"valid_range",fmt.Sprintf("0..%d", len(pe.MessageDetails)-1),
//		)
//	}
//	return value, err
//}
...
//				goto end
//			}
//			// 2) interface implementation (handle *interface, interface, *T, T)
